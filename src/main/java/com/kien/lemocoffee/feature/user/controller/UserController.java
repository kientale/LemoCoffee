package com.kien.lemocoffee.feature.user.controller;
...
import com.kien.lemocoffee.feature.user.utils.UserValidator;
...
public class UserController {
    ...
    private static final String CONTENT = "pages/user/user-management";
