...
import com.kien.keycoffee.normalizer.DrinkInfoNormalizer;
...
import com.kien.keycoffee.validate.DrinkValidator;
...
public class DrinkController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).DRINK_VIEW.name())")
    ...
    @PreAuthorize("""
                hasAnyAuthority(
                T(com.kien.keycoffee.constant.PermissionEnum).DRINK_CREATE.name(),
                T(com.kien.keycoffee.constant.PermissionEnum).DRINK_UPDATE.name()
            )
            """)
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).DRINK_CREATE.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).DRINK_UPDATE.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).DRINK_STATUS_UPDATE.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).DRINK_DELETE.name())")
