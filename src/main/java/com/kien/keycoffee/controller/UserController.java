...
import com.kien.keycoffee.constant.PermissionEnum;
...
import com.kien.keycoffee.normalizer.UserInfoNormalizer;
import com.kien.keycoffee.service.UserService;
import com.kien.keycoffee.validate.UserValidator;
...
public class UserController {
    ...
    @GetMapping
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).USER_VIEW.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).USER_CREATE.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).USER_UPDATE.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).USER_DELETE.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).USER_STATUS_UPDATE.name())")
    ...
    @PreAuthorize("hasAuthority(T(com.kien.keycoffee.constant.PermissionEnum).USER_RESET_PASSWORD.name())")
